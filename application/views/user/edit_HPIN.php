...
<form action="<?php echo site_url("user/HPIN/".$type);?>" method="post" onSubmit="return V_CheckPassword();">
<table>
<tbody>
<?php echo validation_errors('<tr><td colspan="3" class="error">','</td></tr>'),$this->safe->safe_errors('<tr><td colspan="3" class="error">','</td></tr>');?>
<?php if($type=='creat'){?>
<tr><td colspan="3" class="table_notice"><?php echo $status?'成功创建登录记录查看密码，请牢记':'还没有设置登录记录查看密码，请创建新密码';?></td></tr>
<?php } if($type=='edit' || $status){
if($type=='edit' && $status){?>
<tr><td colspan="3" class="table_notice">成功修改登录记录查看密码,请牢记</td></tr>
<?php }?>
